...
<%
	...
	//设置文件在服务器的保存位置,默认从当前应用的根目录开始
	String filepath = "upload\\";
	filepath += file.getFileName();
	System.out.println("file is uploaded to the path:"+filepath);
	//文件另存为   
	//file.setCharset("gbk");
	...
	i = nm.updateNewsByNid(nid,n);
	if (i > 0) {
%>
<script type="text/javascript">
	alert("已经成功修改新闻，点击确认返回新闻列表");
